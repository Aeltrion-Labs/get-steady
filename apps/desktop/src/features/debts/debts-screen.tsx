      ...
      <div className="grid gap-5 rounded-[32px] border border-border bg-card/95 p-6 shadow-card lg:grid-cols-[1.3fr,0.9fr]">
        <div className="space-y-4">
          ...
          <h1 className="font-display text-4xl text-foreground">
            Track balances without pretending complexity helps.
          </h1>
          <p className="max-w-2xl text-sm leading-6 text-muted-foreground">
            Keep the current balance honest, record payments, and make the outstanding total visible
            every day.
          </p>
        ...
        <Card className="space-y-4">
          <div>
            ...
            <h2 className="mt-3 font-display text-2xl text-foreground">
              Add a balance you want to keep visible.
            </h2>
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              Keep the setup compact. You can start with the name and current balance, then fill in
              lender and due details later.
            </p>
          </div>
          <DebtForm
                ...
                <div className="mb-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Capture the movement now so the balance stays honest.
                    </p>
                  </div>
                </div>
                <PaymentForm
          ...
          <Card className="border-warning/30 bg-warning/5">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Start with the balances that most affect your monthly breathing room. You can add
                  the rest later.
                </p>
              </div>
            </div>
