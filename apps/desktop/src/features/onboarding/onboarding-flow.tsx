          ...
          <div className="relative space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-lg text-base leading-7 text-slate-200/88">
                Get Steady is a quiet local console for money awareness. The goal is not perfection.
                It is helping you face today, reduce debt pressure, and keep cashflow visible
                without a giant budgeting setup.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-sm leading-6 text-muted-foreground">
                  ...
                  questionnaire, no pressure to get everything perfect before you begin.
                </p>
              </div>
          ...
          {step === "finish" ? (
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-sm leading-6 text-muted-foreground">
                  Start with one income or expense entry, glance at debt if it matters today, and
                  close the loop when the day feels accounted for.
                </p>
              </div>
